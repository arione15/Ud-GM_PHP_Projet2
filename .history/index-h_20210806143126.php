...
<body>
  ...
  <img src="./source/Jeux.png" class="card-img-top">
  <div class="card-body">
    <h5 class="card-title">JavaScript</h5>
    <p class="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta eos autem repellat blanditiis ullam possimus et doloremque, unde vel odio!</p>
    <a href="#" class="btn btn-primary">JavaGo somewhere</a>
  </div>
</div>
